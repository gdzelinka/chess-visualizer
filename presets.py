...
- pieces: A dictionary mapping (row, col) tuples to piece keys
          (e.g., 'White_Pawn' for white pawn)
"""
...
STANDARD_CHESS = {
    ...
    'pieces': {
        ...
        # Pawns
        (6, 0): 'White_Pawn', (6, 1): 'White_Pawn',
        (6, 2): 'White_Pawn', (6, 3): 'White_Pawn',
        (6, 4): 'White_Pawn', (6, 5): 'White_Pawn',
        ...
        # Pawns
        (1, 0): 'Black_Pawn', (1, 1): 'Black_Pawn',
        (1, 2): 'Black_Pawn', (1, 3): 'Black_Pawn',
        (1, 4): 'Black_Pawn', (1, 5): 'Black_Pawn',
...
SHOGI_STANDARD = {
    ...
    'pieces': {
        ...
        (6, 2): 'White_Shogi_Pawn', (6, 3): 'White_Shogi_Pawn',
        (6, 4): 'White_Shogi_Pawn', (6, 5): 'White_Shogi_Pawn',
        (6, 6): 'White_Shogi_Pawn', (6, 7): 'White_Shogi_Pawn',
        (6, 8): 'White_Shogi_Pawn',
        ...
        (2, 2): 'Black_Shogi_Pawn', (2, 3): 'Black_Shogi_Pawn',
        (2, 4): 'Black_Shogi_Pawn', (2, 5): 'Black_Shogi_Pawn',
        (2, 6): 'Black_Shogi_Pawn', (2, 7): 'Black_Shogi_Pawn',
        (2, 8): 'Black_Shogi_Pawn',
    }
}
